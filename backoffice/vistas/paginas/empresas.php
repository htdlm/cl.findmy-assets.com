    ...
    <div class="box">
        ...
        <div class="card card-purple card-outline">
            ...
            <div class="card-header">
                ...
                <button class="btn btn-purple" data-toggle="modal" data-target="#modalAgregarEmpresa">
       ...
       <table class="table table-bordered table-striped dt-responsive tablaEmpresas table-sm" width="100%">
...
<?php
  ...
  $eliminarEmpresa = new ControladorProductos();
