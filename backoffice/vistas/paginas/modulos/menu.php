<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <img src="vistas/img/vectors/Favicon.svg" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light"> <?php echo DICPY ?> </span>
  </a>
