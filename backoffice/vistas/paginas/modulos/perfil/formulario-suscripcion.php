...
<div class="col-12 col-md-8">
	...
	<div class="card card-primary card-outline">
		...
		<div class="card-body">
			...
			<h6 class="card-title">¡Obtenga su acceso a la plataforma!</h6>
			
			<br>

			<p class="card-text">Al activar su membresía mensual ingresa en nuestro programa de afiliados, el cual podrá generar mensualidades gratis, más información ingrese a la página <a href="plan-compensacion">Plan de compensanción.</a></p>
			...
			<div class="form-group">
				...
				<span>(Compartiendo este enlace podrá ganar mensualidades gratis, más información: <a href="plan-compensacion">Plan de compensanción</a>)</span>

				<div class="input-group"> 
					<div class="input-group-prepend">
						<span class="p-2 bg-info rounded-left">http://cl.findmy-assets.com/</span>
					</div>
			...
			<div class="form-group">
				...
				<select class="form-control" id="tipoRed">
					...
					<option value="uninivel">Plan Básico (9 usuarios, 9 empresas)</option>
					<option value="binaria">Plan Medio (49 usuarios, 49 empresas)</option>
					<option value="matriz">Plan Completo (99 usuarios, 99 empresas)</option>
...
if(isset($_GET["subscription_id"])){
	...
	if ($err) {
		...
		curl_setopt_array($curl2, array(
			CURLOPT_URL => "https://api.sandbox.paypal.com/v1/billing/subscriptions/".$_GET["subscription_id"],
			CURLOPT_RETURNTRANSFER => true,
			CURLOPT_ENCODING => "",
			CURLOPT_MAXREDIRS => 10,
			CURLOPT_TIMEOUT => 300,
			...
			CURLOPT_HTTPHEADER => array(
				...
				"postman-token: ec6c16cf-991b-951d-4de0-bf3fd7338a3f"
				),
			));
		...
		if ($err) {
			...
			if($estado == "ACTIVE"){
				...
				$datos = array("id_usuario" => $usuario["id_usuario"],
								...
								"enlace_afiliado" => $confimarPatrocinador,
