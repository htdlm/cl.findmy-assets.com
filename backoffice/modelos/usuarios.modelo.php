...
class ModeloUsuarios{
	...
	static public function mdlRegistroUsuario($tabla, $datos)
    {
        ...
        try
        {
            ...
            $stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(perfil, nombre, email, password, suscripcion, verificacion, email_encriptado, patrocinador,admin_user) VALUES (:perfil, :nombre, :email, :password, :suscripcion, :verificacion, :email_encriptado, :patrocinador, :admin_user)");
            ...
            {
                $valor = $e->getMessage();
                echo "Error Insertando en la BD: ".$valor;
            }
