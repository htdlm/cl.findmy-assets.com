...
if(isset($_GET["pagina"])){
	...
	if($validarCorreo["email_encriptado"] == $_GET["pagina"]){
        ...
        $respuesta = ControladorUsuarios::ctrActualizarUsuario($id, "max_user", 1);
        $respuesta = ControladorUsuarios::ctrActualizarUsuario($id, "max_company", 1);
