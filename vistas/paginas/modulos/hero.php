...
<div class="container-fluid vistaVideo p-0">
	...
	<video class="d-none d-lg-block" id="videoPresentacion" muted="muted" autoplay loop preload="auto" width="100%" height="100%">
	...
	<div class="container">
		...
		<h2 class="text-center text-white pb-1 pb-lg-4">Activos Fijos</h2>
