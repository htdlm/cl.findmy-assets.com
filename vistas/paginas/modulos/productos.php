		...
		<div class="row">
			...
			<div class="col-sm-3">
				<div align="center">
					...
					<h6 class="text-center p-4"> Haz login en nuestro sitio y accede a Find My-Assets donde estés. </h6>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div align="center">
					...
					<h6 class="text-center p-4"> Ingresa tus activos en forma unitaria o masiva e indica su método de contabilización.​ </h6>
				</div>
			</div>
			...
			<div class="col-sm-3">
				<div align="center">
					...
					<h6 class="text-center p-4"> Edita online la información de tus activos, agrega fotografías y registra mantenciones preventivas y correctivas.​ </h6>
				</div>
			</div>
			...
			<div class="col-sm-3 justify-content-center">
				<div align="center">
					...
					<h6 class="text-center p-4"> Visualiza la ubicación de tus activos, identifica sus vencimientos y cuantifica su valor actualizado.​ </h6>
				</div>
			</div>
